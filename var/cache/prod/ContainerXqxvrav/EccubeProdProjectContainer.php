...
class EccubeProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Plugin\\AmazonPay\\Repository\\ConfigRepository' => 'getConfigRepositoryService.php',
            'Plugin\\AmazonPay\\Repository\\Master\\AmazonStatusRepository' => 'getAmazonStatusRepositoryService.php',
            'Plugin\\AmazonPay\\Repository\\PaymentStatusRepository' => 'getPaymentStatusRepositoryService.php',
            ...
            'security.request_matcher.aeplp8p' => 'getSecurity_RequestMatcher_Aeplp8pService.php',
        ...
        $this->privates = [
            ...
            'security.request_matcher.aeplp8p' => true,
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $g = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/AmazonPay/Entity')]);
        ...
        $d->addDriver($g, 'Plugin\\AmazonPay\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Repository\\AuthorityRoleRepository' => function () {
            ...
            return ${($_ = isset($this->services['Plugin\\AmazonPay\\Repository\\ConfigRepository']) ? $this->services['Plugin\\AmazonPay\\Repository\\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'};
        }, 'Plugin\\AmazonPay\\Repository\\Master\\AmazonStatusRepository' => function () {
            return ${($_ = isset($this->services['Plugin\\AmazonPay\\Repository\\Master\\AmazonStatusRepository']) ? $this->services['Plugin\\AmazonPay\\Repository\\Master\\AmazonStatusRepository'] : $this->load('getAmazonStatusRepositoryService.php')) && false ?: '_'};
        }, 'Plugin\\AmazonPay\\Repository\\PaymentStatusRepository' => function () {
            return ${($_ = isset($this->services['Plugin\\AmazonPay\\Repository\\PaymentStatusRepository']) ? $this->services['Plugin\\AmazonPay\\Repository\\PaymentStatusRepository'] : $this->load('getPaymentStatusRepositoryService.php')) && false ?: '_'};
        }])));
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.aeplp8p']) ? $this->services['security.request_matcher.aeplp8p'] : ($this->services['security.request_matcher.aeplp8p'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
