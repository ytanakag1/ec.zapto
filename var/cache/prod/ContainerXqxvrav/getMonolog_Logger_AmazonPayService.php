...
// Returns the public 'monolog.logger.amazon_pay' shared service.

$this->services['monolog.logger.amazon_pay'] = $instance = new \Symfony\Bridge\Monolog\Logger('amazon_pay');
...
$instance->pushHandler(${($_ = isset($this->services['monolog.handler.amazon_pay']) ? $this->services['monolog.handler.amazon_pay'] : $this->load('getMonolog_Handler_AmazonPayService.php')) && false ?: '_'});
