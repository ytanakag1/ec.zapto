...
namespace Proxies\__CG__\Plugin\AmazonPay\Entity\Master;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class AmazonStatus extends \Plugin\AmazonPay\Entity\Master\AmazonStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AmazonStatus $proxy) {
